...
command! -nargs=0 FloatermToggle call floaterm#toggleTerminal()
command! -nargs=0 FloatermNew    call floaterm#newTerminal()
command! -nargs=0 FloatermPrev   call floaterm#prevTerminal()
command! -nargs=0 FloatermNext   call floaterm#nextTerminal()
